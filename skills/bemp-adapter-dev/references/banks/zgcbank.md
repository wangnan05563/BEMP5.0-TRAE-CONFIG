# 中国光大银行(zgcbank) 适配器开发参考模板

> bank-key: `zgcbank` | 目录: `ext-zgcbank` | 包: `com.hundsun.bemp.zgcbank.adapter.msg`
> 状态: **LEGACY** | Converter: **94** | Test: **0**
...
- `AbstractEsbMessageRequestReplyConverter`
