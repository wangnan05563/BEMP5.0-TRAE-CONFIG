# 汇商银行（huisbank）适配器开发参考模板

> bank-key: `huisbank` | 目录: `ext-huisbank` | 包: `com.hundsun.bemp.huisbank.adapter.msg`
> 状态: **IMPLEMENTED** | Converter: **88** | Test: **0**
...
```
com/hundsun/bemp/huisbank/adapter/msg/
├── client/
├── common/
├── constant/
├── server/
