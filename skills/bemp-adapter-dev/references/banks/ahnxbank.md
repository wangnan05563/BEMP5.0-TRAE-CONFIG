# 安徽农商银行（ahnxbank）适配器开发参考模板

> bank-key: `ahnxbank` | 目录: `ext-ahnxbank` | 包: `com.hundsun.bemp.ahnxbank.adapter.msg`
> 状态: **IMPLEMENTED** | Converter: **144** | Test: **0**
...
```
com/hundsun/bemp/ahnxbank/adapter/msg/
├── client/
├── credit/
├── common/
├── utils/
...
- `AbstractSocketMessageRequestReplyConverter`
