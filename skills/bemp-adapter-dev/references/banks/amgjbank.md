# 澳门国际银行（amgjbank）适配器开发参考模板

> bank-key: `amgjbank` | 目录: `ext-amgjbank` | 包: `com.hundsun.bemp.amgjbank.adapter.msg`
> 状态: **IMPLEMENTED** | Converter: **95** | Test: **0**
...
```
com/hundsun/bemp/amgjbank/adapter/msg/
├── client/
├── credit/
├── server/
```
