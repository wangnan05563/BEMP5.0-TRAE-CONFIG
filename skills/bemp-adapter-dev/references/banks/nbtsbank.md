# 宁波通商银行（nbtsbank）适配器开发参考模板

> bank-key: `nbtsbank` | 目录: `ext-nbtsbank` | 包: `com.hundsun.bemp.nbtsbank.adapter.msg`
> 状态: **IMPLEMENTED** | Converter: **131** | Test: **0**
...
```
com/hundsun/bemp/nbtsbank/adapter/msg/
├── client/
├── credit/
├── common/
├── server/
