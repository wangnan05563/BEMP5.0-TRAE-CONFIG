...
| V2.3.2 | 评估修复：$Host遮蔽、超时控制、TNS检测、DryRun移除、版本统一、ConfigFile参数、权限IP限制 |
| V2.3.3 | Token深度优化：条件加载（7块低频内容→独立文件引用）+ 对称合并（Oracle/MySQL统一模板）+ MCP调用合并 + 冗余删除，SKILL.md 735→378行（-48.6%） |
